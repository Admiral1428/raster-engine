...
void Hangar::make_shape()
{
    ...
    rects.back().rotate(180.0f, 0.0f, 0.0f, "roll-pitch-yaw");
    rects.back().translate(0.0f, 3.0f, -3.5f);
    ...
    triangles.push_back(Surface(Eigen::Vector4f(5.0f, 6.0f, -3.5f, 1.0f), Eigen::Vector4f(0.0f, 8.5f, -3.5f, 1.0f), Eigen::Vector4f(-5.0f, 6.0f, -3.5f, 1.0f), {GRAY}));

    // left roof
    rect_prisms.push_back(RectPrism(0.0f, 0.0f, 0.0f, 6.92f, 0.4f, 7.5f, {WHITE, WHITE, GRAY, WHITE, GRAY, NIGHTGRAY}));
    rect_prisms.back().rotate(0.0f, 0.0f, 27.0f, "roll-pitch-yaw");
    rect_prisms.back().translate(-3.0f, 7.2f, 0.0f);

    // right roof
    rect_prisms.push_back(RectPrism(0.0f, 0.0f, 0.0f, 6.92f, 0.4f, 7.5f, {WHITE, WHITE, WHITE, GRAY, GRAY, NIGHTGRAY}));
    rect_prisms.back().rotate(0.0f, 0.0f, -27.0f, "roll-pitch-yaw");
    rect_prisms.back().translate(3.0f, 7.2f, 0.0f);
