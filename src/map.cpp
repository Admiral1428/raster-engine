...
{
    // right tree
    shapes_rect_prism.push_back(RectPrism(2.5f, -1.0f, -7.0f, 0.5f, 2.0f, 0.5f, {BROWN, BROWN, TAN, TAN, BLACK, BLACK}, false, {"top", "bottom"}));
    shapes_pyramid.push_back(Pyramid(2.5f, 0.0f, -7.0f, 2.0f, 2.0f, 2.0f, {DKGREEN, DKGREEN, MEDGREEN, MEDGREEN, BLACK}));

    // left tree
    shapes_rect_prism.push_back(RectPrism(-2.8f, 0.0f, -10.0f, 0.75f, 4.0f, 0.75f, {BROWN, BROWN, TAN, TAN, BROWN, BROWN}, false, {"top", "bottom"}));
