...
Initially, I considered making a more primitive engine using ray-casting techniques, as seen in early 3D games on the PC such as *Hovertank 3-D (1991)*, *Catacomb 3-D (1991)*, and *Wolfenstein 3D (1992)*. However, this tile-based ray-casting approach imposed limitations on map design, preventing features like diagonal walls, sloped surfaces, or multiple vertical levels. Fewer limitations were present in "2.5D" engines that used a sector-based approach, such as the id Tech 1 engine which powered *Doom (1993)*, enabling stairs, lifts, and more complex architecture. A further evolution was the Build engine, used for *Duke Nukem 3D (1996)*, which expanded on this sector-based approach to support sloped floors and ceilings. For full 3D environments, the id Tech 2 engine for *Quake (1996) / GLQuake (1997)* and Unreal Engine 1.0 for *Unreal (1998)* represented the world and objects using true 3D models, rather than relying on sprites for object geometry or a 2D sector-based approach for level design. These advanced engines also supported both software and hardware-accelerated rendering, as consumer GPUs were just becoming mainstream. I aimed to achieve this early level of full 3D fidelity, excluding complex gameplay mechanics, by building my custom engine with software rendering.
